...
def read_videos_by_user_id(
    ...
    return crud.video.get_multi_by_owner(db, owner_id=user_id, skip=skip, limit=limit)
...
def read_label_occurances_by_user_id(
    ...
    return crud.label_occurance.get_multi_by_owner(db, owner_id=user_id, with_label_names=with_label_names, skip=skip, limit=limit)
